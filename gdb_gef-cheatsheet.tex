...
\gdb{\texttt{ptype} \textit{expr}} prints the type of \textit{expr}.
An expression of the form \texttt{\{\textit{t}\}}\textit{addr} refers to an object of type \textit{t}, stored at address \textit{addr} in memory.
